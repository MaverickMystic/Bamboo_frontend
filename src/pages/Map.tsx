...
const Map = () => {
  return (
    <div className="md:mt-10 pt-5 mx-2 md:mx-0" >
      <div className="flex flex-col justify-center items-center">
        <h1 className="flex flex-row font-bold text-xl text-greensage items-center mb-5"><FaSearchLocation className="mx-2 hidden md:visible" /> BAMBOO JAPANESE LANGUAGE SCHOOL</h1>
        <h1 className="text-center mb-10">Address:No(47),Thayaphi Street,Thapyaygone Quarter,Zabuthiri Twonship,Naypyitaw, Myanmar, 15011Phone: +95 9 44244 3388</h1>
        <iframe
